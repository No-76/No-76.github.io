import{_ as s,o as a,c as t,e as p,b as n,d as o,a as e}from"./app-8efccdb2.js";const c="/assets/image-3-e34be908.png",i="/assets/image-4-0651f7de.png",l="/assets/image-5-3e74d6bc.png",u="/assets/image-2-6e634c18.png",r={},k=n("h1",{id:"共轭梯度法",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#共轭梯度法","aria-hidden":"true"},"#"),o(" 共轭梯度法")],-1),d=n("p",null,"需要注意共轭梯度法对于n为矩阵，最多只需要n步就可以迭代到最优解，后跟梯度下降进行对比。",-1),v=e('<p><img src="'+c+'" alt="Alt text" loading="lazy"><br> 在最优化课程讲到了他的证明。<br><img src="'+i+'" alt="Alt text" loading="lazy"><br><img src="'+l+'" alt="Alt text" loading="lazy"></p><p>现在解决下面问题：<br><img src="'+u+`" alt="Alt text" loading="lazy"></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> numpy <span class="token keyword">as</span> np
