import{_ as s,o as a,c as e,a as l,b as n,d as i}from"./app-910ab873.js";const r="/assets/image-5c0d93e0.png",t="/assets/image-1-8eb0d904.png",d={},m=l(`<h1 id="lu分解" tabindex="-1"><a class="header-anchor" href="#lu分解" aria-hidden="true">#</a> LU分解</h1><p>LU分解相较于传统的高斯消元法，虽然具有相同的时间复杂度，但是面对不同的b值并不需要像高斯消元那样多次运行。下面的代码中用一个矩阵存储L和U矩阵。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>def lu_decomposition(matrix):
    # 只能用于方阵
