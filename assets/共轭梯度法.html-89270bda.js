import{_ as s,o as a,c as t,e as p,b as n,d as o,a as e}from"./app-d20434f8.js";const c="/assets/426ae8c5ed2ec4629d7d7d4a62ac5eb-bd6c4462.png",l="/assets/image-2-6e634c18.png",i={},u=n("h1",{id:"共轭梯度法",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#共轭梯度法","aria-hidden":"true"},"#"),o(" 共轭梯度法")],-1),r=n("p",null,"需要注意共轭梯度法对于n为矩阵，最多只需要n步就可以迭代到最优解，后跟梯度下降进行对比。",-1),k=e('<p><img src="'+c+'" alt="Alt text" loading="lazy"><br><img src="'+l+`" alt="Alt text" loading="lazy"></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> numpy <span class="token keyword">as</span> np
...
</code></pre>`,3);function d(v,m){return a(),t("div",null,[u,r,p(" more "),k])}const _=s(i,[["render",d],["__file","共轭梯度法.html.vue"]]);export{_ as default};
